...
async def submit_data(data: StudentData):
    ...
    Từ những thông tin trên của HS đưa ra, hãy viết một đoạn phân tích ngắn khoảng 2 đoạn và mỗi đoạn 5 câu, có thêm 1 số icon tích cực, thân thiện và giúp học sinh cảm thấy tích cực hơn.
    """
